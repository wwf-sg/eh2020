...
if (!is_admin()) { ?>
                                ...
                                <div class="short-form mt-5" v-show="short_form_check">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div v-show="path == 2">
                                                <?php if ($p_id == 1757) : ?>
                                                    <h4 class="mb-2">You could be consuming about <span class="plastic_value highlight red impact">&nbsp;5 grams &nbsp;</span> of plastic a week.</h4>
                                                <?php else : ?>
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div style="background-color: #b8d4f4;">
                                                    <div style="background-color: #2287ff;height: 10px; max-width: <?= (str_replace(',', '', $signature_count['global']) / 2000000) * 100 ?>%;"></div>
                                                </div>
                                ...
                                <div>
                                    <div v-show="form.country == 'SG'" >
                                        <div v-show="short_form_check" class="text-left container" style="max-width: 480px;">
                                            ...
                                            <h6>We will use your voice to ask for change at <span class="blue bg-transparent">every relevant</span> meeting of <span class="blue bg-transparent">governments and businesses</span> that we have access to, anywhere in the world.</h6>
                                        </div>
                                        <div v-show="!short_form_check">
    ...
    <script>
        ...
        var skip_plastic_test = <?php echo (get_field('skip_plastic_test') === false ? 0 : 1) ?>;
