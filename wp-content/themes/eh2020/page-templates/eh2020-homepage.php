...
<div id="primary" class="entry">
	...
	<section id="countdown">
		...
		<!-- Form -->
		<div class="entry-content" id="open-letter">
		<div id="voice" class="alignfull">
			<?php
            require __DIR__ . '/../partials/voice.php';
            ?>
	...
	<!-- Youtube -->
	<section id="youtube" class="bg-black text-white text-center">
		<div class="container">
			<h1>Missed Earth Hour 2020? We got you covered!</h1>
			<div class="embed-responsive embed-responsive-16by9 mb-3">
				<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/r2iPrQ5tgnE?rel=0&modestbranding=1&autohide=1&showinfo=0&controls=1&autoplay=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			</div>
			...
			<div style="max-width: 600px" class="m-auto pt-5">
		...
		<div class="container pb-5">
			<div class="row">
				<div class="col col-lg-8 offset-lg-2 text-white">
					...
					<p>Global leaders, celebrities, individuals and businesses from 190 countries and territories came together on Saturday, 28th March, to lend their support for the planet.</p>
					<p> A people-led movement, Earth Hour 2020 beautifully exemplified the resilience of the human spirit amid a crisis. At a time when people across the globe are battling a health crisis of an unforeseen scale, and many countries are under complete lockdown, supporters rose to the challenge of marking Earth Hour with online events.</p><p> Earth Hour 2020 generated over 3 billion social media impressions globally and its related hashtags trended across 37 countries on Twitter and Google search, making it one of the most successful online events in its history.</p>
					<p> Watch the highlights  <a target="_blank" href="https://youtu.be/prYZikbnVRk">here.</a></p>
	...
	<section class="line-up my-5 py-5 text-white text-center bg-black">
		<div class="container">
			<h2 class="mb-5">Thank you for making Earth Hour 2020 happen!</h2>
			<div class="row">
				<div class="col-6 col-md-4">
					<div>
						<img class="mx-auto" src="<?php echo esc_html(get_stylesheet_directory_uri()); ?>/imgs/Musicians-02.png" alt="" />
				...
				<div class="col-6 col-md-4">
					<div>
						<img class="mx-auto" src="<?php echo esc_html(get_stylesheet_directory_uri()); ?>/imgs/Musicians-01.png" alt="" />
						<h3>RRILEY</h3>
						<p>5:30PM to 8:30PM</p>
					</div>
				</div>
				<div class="col-6 col-md-4">
					<div>
						<img class="mx-auto" src="<?php echo esc_html(get_stylesheet_directory_uri()); ?>/imgs/Musicians-03.png" alt="" />
				...
				<div class="col-6 col-md-4">
					<div>
						<img class="mx-auto" src="<?php echo esc_html(get_stylesheet_directory_uri()); ?>/imgs/Musicians-04.png" alt="" />
						<h3>Preetipls</h3>
						<p>5:30PM to 8:30PM</p>
					</div>
				</div>
				<div class="col-6 col-md-4">
					<div>
						<img class="mx-auto" src="<?php echo esc_html(get_stylesheet_directory_uri()); ?>/imgs/Musicians-07.png" alt="" />
						<h3>Subhas</h3>
						<p>5:30PM to 8:30PM</p>
					</div>
				</div>
				<div class="col-6 col-md-4">
					<div>
						<img class="mx-auto" src="<?php echo esc_html(get_stylesheet_directory_uri()); ?>/imgs/Musicians-05.png" alt="" />
						<h3>Sezairi</h3>
						<p>5:30PM to 8:30PM</p>
					</div>
				</div>
				<div class="col-6 col-md-4">
					<div>
						<img class="mx-auto" src="<?php echo esc_html(get_stylesheet_directory_uri()); ?>/imgs/Musicians-06.png" alt="" />
						<h3>Inch Chua</h3>
						<p>5:30PM to 8:30PM</p>
					</div>
				</div>
				<div class="col-6 col-md-4">
					<div>
						<img class="mx-auto" src="<?php echo esc_html(get_stylesheet_directory_uri()); ?>/imgs/Musicians-11.png" alt="" />
