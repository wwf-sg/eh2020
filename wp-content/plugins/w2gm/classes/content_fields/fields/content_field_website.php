...
class w2gm_content_field_website extends w2gm_content_field {
	...
	public function renderInput() {
		...
		if (!($template = w2gm_isTemplate('content_fields/fields/website_input_'.$this->id.'.tpl.php'))) {
	...
	public function renderOutput($listing, $group = null) {
		if (!($template = w2gm_isTemplate('content_fields/fields/website_output_'.$this->id.'.tpl.php'))) {
