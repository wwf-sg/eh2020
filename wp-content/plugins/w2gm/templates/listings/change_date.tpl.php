...
<?php if (!get_option('w2gm_change_expiration_date') && current_user_can('manage_options')): ?>
<p><?php _e("Regular users can not change expiration date. This option is available only for admins.", 'W2GM'); ?></p>
<?php endif; ?>
