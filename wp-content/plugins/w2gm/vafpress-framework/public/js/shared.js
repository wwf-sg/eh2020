...
vp_w2gm.init_controls = function($parent)
{
	...
	vp_w2gm.init_select2vp($parent.find('.vp-js-select2vp'));
...
// select2vp
vp_w2gm.init_select2vp = function($elements)
{
	if (jQuery.fn.select2vp)
	{
		if($elements.length <= 0)
			return;
		$elements.select2vp({allowClear: true, placeholder: vp_w2gm_wp.ctrl_msg.select2vp_placeholder});
	}
};
