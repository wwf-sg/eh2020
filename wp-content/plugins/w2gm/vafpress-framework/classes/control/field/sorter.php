...
class VP_W2GM_Control_Field_Sorter extends VP_W2GM_Control_FieldMulti implements VP_W2GM_MultiSelectable
{
	...
	protected function _setup_data()
	{
		...
		$this->add_data('opt', VP_W2GM_Util_Text::make_opt($opt));
	...
	public function render($is_compact = false)
	{
		...
		return VP_W2GM_View::instance()->load('control/sorter', $this->get_data());
	}
