...
class VP_W2GM_WP_Loader
{
	...
	{
		$this->_dependencies = apply_filters( 'vp_w2gm_dependencies_array', VP_W2GM_Util_Config::instance()->load('dependencies') );
		$this->_types        = array(
			'option'             => array(),
			'metabox'            => array(),
	...
	public function build()
	{
		...
		// register and add w2gm_shared-js at the end of dependencies
		$this->js_unit_register('w2gm_shared', $req_scripts);
		...
		do_action( 'vp_w2gm_after_dependencies_loader_build' );
	...
	private function build_localize_data()
	{
		...
		$localize = array(
			...
			// validatable data
			'alphabet_validatable'     => apply_filters( 'vp_w2gm_alphabet_validatable'    , array( 'vp-textbox', 'vp-textarea' ) ),
			'alphanumeric_validatable' => apply_filters( 'vp_w2gm_alphanumeric_validatable', array( 'vp-textbox', 'vp-textarea' ) ),
			'numeric_validatable'      => apply_filters( 'vp_w2gm_numeric_validatable'     , array( 'vp-textbox', 'vp-textarea' ) ),
			'email_validatable'        => apply_filters( 'vp_w2gm_email_validatable'       , array( 'vp-textbox', 'vp-textarea' ) ),
			'url_validatable'          => apply_filters( 'vp_w2gm_url_validatable'         , array( 'vp-textbox', 'vp-textarea' ) ),
			'maxlength_validatable'    => apply_filters( 'vp_w2gm_maxlength_validatable'   , array( 'vp-toggle', 'vp-radiobutton', 'vp-radioimage', 'vp-select' ) ),
			'minlength_validatable'    => apply_filters( 'vp_w2gm_minlength_validatable'   , array( 'vp-toggle', 'vp-radiobutton', 'vp-radioimage', 'vp-select' ) ),
		);
