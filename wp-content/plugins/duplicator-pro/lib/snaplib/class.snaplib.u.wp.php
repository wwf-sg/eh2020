    ...
    class DupProSnapLibUtilWp
    {
        ...
        public static function getHomePath()
        {
            ...
            if (is_null($home_path)) {
                ...
                $realScriptDirname = DupProSnapLibIOU::safePathTrailingslashit(dirname($_SERVER['SCRIPT_FILENAME']), true);
                ...
                if (strpos($realScriptDirname, $realAbsPath) === 0) {
                    ...
                    if (!empty($home) && 0 !== strcasecmp($home, $siteurl)) {
                        if (stripos($siteurl, $home) === 0) {
                            ...
                            $pos                 = strripos(str_replace('\\', '/', $_SERVER['SCRIPT_FILENAME']), DupProSnapLibIOU::trailingslashit($wp_path_rel_to_home));
                    ...
                    $home_path = DupProSnapLibIOU::trailingslashit(dirname($_SERVER['SCRIPT_FILENAME']));
                }
